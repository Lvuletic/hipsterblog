...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "hipsterblog@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "hipsterblog API";

        private String description = "hipsterblog API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "hipsterblog";
